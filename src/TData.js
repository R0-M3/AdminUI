function TData({ data, types, edit, userData, updateUserData }) {
  return (
    <td className='border border-slate-400'>
      <input types='text' onChange={(e) => updateUserData(e.target)} autoComplete='false' disabled={edit} name={types} className='p-2 border-2 border-stone-600 disabled:bg-inherit'
